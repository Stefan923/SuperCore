...
public final class SQLStatement {
    ...
    public static final String CREATE_USER = "INSERT INTO `{prefix}users` (`uuid`, `username`) VALUES(?, ?);";
    public static final String CREATE_USER_DATA = "INSERT INTO `{prefix}user_data` (`userUUID`, `language`, `balance`, `lastOnline`, `customNickname`) VALUES(?, 'default', 0, NOW(), NULL);";
    public static final String CREATE_USER_SETTINGS = "INSERT INTO `{prefix}user_settings` (`userUUID`) VALUES(?);";
