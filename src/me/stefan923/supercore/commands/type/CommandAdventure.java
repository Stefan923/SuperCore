...
public class CommandAdventure extends AbstractCommand implements MessageUtils, PlayerUtils {

    public CommandAdventure() {
        super(false, true, "adventure");
    }
    ...
    public String getDescription() {
        return "Change your gamemode to adventure.";
    }
