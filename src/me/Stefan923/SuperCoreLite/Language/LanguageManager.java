...
public class LanguageManager implements MessageUtils {
    ...
    public void setup(Plugin p, String languageFile) {
        ...
        config.addDefault("Command.Gamemode.Adventure", "adventure");
        config.addDefault("Command.Gamemode.Creative", "creative");
        ...
        config.addDefault("Command.Gamemode.Spectator", "spectator");
        config.addDefault("Command.Gamemode.Survival", "Survival");
